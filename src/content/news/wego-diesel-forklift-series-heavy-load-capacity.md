---
translationKey: wego-diesel-forklift-series-heavy-load-capacity
permalink: wego-diesel-forklift-series-heavy-load-capacity
category: product-guide
author: WEGO Sales Team
cover: /images/news/wego-diesel-forklift-series-heavy-load-capacity.webp
title:
  ...
  fr: Gamme de chariots diesel WEGO pour la manutention de charges lourdes
  ja: 重量物搬送向け WEGO ディーゼルフォークリフトシリーズ
  de: WEGO Dieselstapler-Reihe fur schwere Lasten
  pt: Linha de empilhadeiras diesel WEGO para movimentacao de cargas pesadas
  ko: 중량 화물 취급용 WEGO 디젤 지게차 라인업
  ar: مجموعة رافعات WEGO الديزل لمناولة الاحمال الثقيلة
excerpt:
  en: From 2 ton to 5 ton capacity, WEGO's diesel lineup targets ports, factories,
    and distributors that need dependable lifting power.
  es: Con capacidades de 2 a 5 toneladas, la gama diesel de WEGO apunta a puertos,
    fabricas y distribuidores que necesitan una elevacion fiable.
  fr: De 2 a 5 tonnes, la gamme diesel WEGO s'adresse aux ports, usines et
    distributeurs qui recherchent une levee fiable.
  ja: 2トンから5トンまでの容量をそろえ、港湾、工场、販売代理店向けに安定した扬重力を提供するシリーズです。
  de: Mit Tragfahigkeiten von 2 bis 5 Tonnen richtet sich die Dieselreihe von WEGO
    an Hafen, Fabriken und Handler mit Bedarf an zuverlassiger Hubkraft.
  pt: Com capacidades de 2 a 5 toneladas, a linha diesel da WEGO atende portos,
    fabricas e distribuidores que precisam de elevacao confiavel.
  ko: 2톤부터 5톤까지의 용량을 갖춘 WEGO 디젤 라인업은 항만, 공장, 대리점의 안정적인 리프팅 수요를 겨냥합니다.
  ar: تغطي مجموعة WEGO الديزل قدرات من 2 إلى 5 اطنان وتستهدف الموانئ والمصانع
    والموزعين الذين يحتاجون إلى قدرة رفع موثوقة.
seoTitle:
  en: Diesel Forklift Range for Heavy Loads | WEGO
  es: Gama diesel para cargas pesadas | WEGO
  fr: Gamme diesel pour charges lourdes | WEGO
  ja: 重量物向けディーゼルフォークリフト | WEGO
  de: Dieselstapler fur schwere Lasten | WEGO
  pt: Linha diesel para cargas pesadas | WEGO
  ko: 중량물용 디젤 지게차 라인업 | WEGO
  ar: رافعات ديزل للاحمال الثقيلة | WEGO
seoDescription:
  en: Review WEGO's 2 ton to 5 ton diesel forklift range for ports, factories, and
    export distribution projects that need durable heavy handling.
  es: Revise la gama diesel WEGO de 2 a 5 toneladas para puertos, fabricas y
    proyectos de distribucion de exportacion que exigen manipulacion pesada
    duradera.
  fr: Decouvrez la gamme diesel WEGO de 2 a 5 tonnes pour ports, usines et projets
    export necessitant une manutention lourde durable.
  ja: 港湾、工场、输出售卖案件向けに、耐久性ある重量搬送を支えるWEGOの2トンから5トンのディーゼルシリーズを绍介します。
  de: Prufen Sie die WEGO-Dieselreihe von 2 bis 5 Tonnen fur Hafen, Fabriken und
    Exportprojekte mit dauerhaft hoher Lastanforderung.
  pt: Conheca a linha diesel WEGO de 2 a 5 toneladas para portos, fabricas e
    projetos de distribuicao de exportacao com demanda pesada continua.
  ko: 항만, 공장, 수출 유통 프로젝트의 중량 작업을 위해 설계된 WEGO 2~5톤 디젤 지게차 라인업을 확인하세요.
  ar: استعرض مجموعة WEGO الديزل من 2 إلى 5 اطنان للموانئ والمصانع ومشروعات التوزيع
    التصديري التي تتطلب مناولة ثقيلة متينة.
body:
  en:
    - WEGO's diesel forklift lineup covers 2 ton to 5 ton capacities so buyers
      can plan around real cargo weight instead of forcing one truck to do every
      job. The range is aimed at ports, factory yards, and high-volume loading
      scenes where traction and lift stability come first.
    - Along with rated capacity, buyers should compare fuel consumption, cab
  ...
  es:
    - La gama diesel de WEGO cubre capacidades de 2 a 5 toneladas para que el
      ...
      solo equipo para todas las tareas. Esta linea se orienta a puertos, patios
      fabriles y escenarios de carga intensiva donde la traccion y la
      estabilidad de elevacion son prioritarias.
    - Ademas de la capacidad nominal, conviene comparar consumo de combustible,
      comodidad de cabina, configuracion del mastil y el primer paquete de
  ...
  fr:
    - La gamme diesel WEGO couvre des capacites de 2 a 5 tonnes afin que
      ...
      d'imposer un seul chariot a tous les travaux. Elle vise les ports, cours
      d'usine et zones de chargement a fort volume ou la traction et la
      stabilite de levage sont prioritaires.
    - Au-dela de la capacite nominale, il faut comparer la consommation, le
  ...
  de:
    - Die Dieselreihe von WEGO deckt Tragfahigkeiten von 2 bis 5 Tonnen ab,
      ...
      einen einzigen Stapler fur alle Aufgaben zu uberlasten. Die Linie richtet
      sich an Hafen, Fabrikhofe und Verladeplatze mit hohem Umschlag, bei denen
      Zugkraft und Hubstabilitat im Vordergrund stehen.
    - Neben der Nenntragfahigkeit sollten Kaufer auch Kraftstoffverbrauch,
      Kabinenkomfort, Mastkonfiguration und das erste Ersatzteilpaket
  ...
  pt:
    - A linha diesel da WEGO cobre capacidades de 2 a 5 toneladas para que o
      ...
      equipamento a fazer todo o trabalho. A serie atende portos, patios
      industriais e areas de carregamento intenso onde tracao e estabilidade de
      elevacao vem em primeiro lugar.
    - Alem da capacidade nominal, vale comparar consumo de combustivel, conforto
      da cabine, configuracao do mastro e o primeiro pacote de pecas de
  ...
  ar:
    - تغطي مجموعة WEGO الديزل قدرات من 2 إلى 5 اطنان حتى يختار المشتري الطراز
      ...
      وتستهدف هذه السلسلة الموانئ وساحات المصانع ومواقع التحميل الكثيف التي
      تتطلب جرا ثابتا ورفعا مستقرا.
